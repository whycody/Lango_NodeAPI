...
describe('matchTranslationsToLemmas', () => {
    ...
    describe('allowedPrefixes', () => {
        ...
        describe('English verbs', () => {
            ...
            it("adds 'to' to word and sets prefix for verbs", () => {
                const translations: TranslationItem[] = [
                    {
                        source: 'run',
                        sourceArticle: 'to',
